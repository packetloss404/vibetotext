...
REM
REM Usage:
REM   build_windows.bat            - Build executables only
REM   build_windows.bat installer  - Build executables + Inno Setup installer
REM
REM Prerequisites:
REM   - Python 3.10+
...
pyinstaller build\vibetotext-engine.spec --noconfirm --distpath dist --workpath pyinstaller_build
if errorlevel 1 (
...
pyinstaller build\vibetotext-ui.spec --noconfirm --distpath dist --workpath pyinstaller_build
if errorlevel 1 (
